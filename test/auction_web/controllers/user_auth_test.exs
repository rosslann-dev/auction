defmodule AuctionWeb.UserAuthTest do
  use AuctionWeb.ConnCase, async: true

  alias Auction.Accounts
  alias AuctionWeb.UserAuth
  import Auction.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, AuctionWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      AuctionWeb.Endpoint.subscribe(live_socket_id)
